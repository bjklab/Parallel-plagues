...
.center[
```{r nextrain_website, echo=FALSE, message=FALSE, error=FALSE, comment=FALSE, eval=TRUE, autodep=TRUE, fig.align='center', out.width='95%'}
knitr::include_url("https://nextstrain.org/ncov/gisaid/global/all-time?gmax=15830&gmin=14088")
```
]

  
.footnote-left[https://nextstrain.org/ncov/gisaid/global/all-time]  
